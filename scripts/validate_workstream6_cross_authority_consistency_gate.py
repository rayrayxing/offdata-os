...
def source_failures(source: dict[str, Any]) -> list[str]:
    ...
    require(
        ...
        == "e22a8357c98c31b62c654ba3734b51b5671232f7",
        "predecessor drift",
    )
    main = source.get("main_integration", {})
    require(
        main.get("integrated_main_sha") == "141ac6ab458fa7354f9b3f8cc57a887f3fceac21",
        "main SHA drift",
    )
    require(main.get("integrated_through") == "WS6.13", "integrated boundary drift")
    require(main.get("earliest_unintegrated") == "WS6.14", "earliest unintegrated drift")
    require(
    ...
    require(
        "WS6.13" in phrase and "WS6.14–WS6.16 final reconciliation" in phrase,
...
def main() -> None:
    ...
    mutations: list[Callable[[dict[str, Any]], None]] = [
        ...
        lambda value: value["main_integration"].update(integrated_through="WS6.14"),
    ...
    print(
        ...
        "domains=12, defects=28, addressed=25, unresolved=3, integrated_through=WS6.13, "
