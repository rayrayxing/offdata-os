...
def source_failures(source: dict[str, Any]) -> list[str]:
    ...
    require(source.get("predecessor", {}).get("head_sha") == "272450f7aa4ac1c5c94c644bd9e1bbaa015685d1", "predecessor drift")
    main = source.get("main_integration", {})
    require(main.get("integrated_main_sha") == "cb2bffe74e62804250ac36168c4206cb8b9d021a", "integrated main drift")
    ...
    require(exception.get("base_sha") == "272450f7aa4ac1c5c94c644bd9e1bbaa015685d1", "exception base SHA drift")
...
def repository_failures(contract: dict[str, Any]) -> list[str]:
    ...
    for token in (
        ...
        "governance/ws614-cross-authority-consistency-gate",
        "272450f7aa4ac1c5c94c644bd9e1bbaa015685d1",
...
def main() -> None:
    ...
    mutations: list[Callable[[dict[str, Any]], None]] = [
        ...
        lambda v: v["main_integration"].update(integrated_through="WS6.8"),
        ...
        lambda v: v["activation"]["activation_exception"].update(base_branch="main"),
