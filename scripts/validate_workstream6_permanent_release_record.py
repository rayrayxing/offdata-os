...
def source_failures(source: dict[str, Any]) -> list[str]:
    ...
    require(pred.get("pull_request") == 56, "predecessor PR drift")
    require(pred.get("branch") == "governance/ws615-final-workflow", "predecessor branch drift")
    require(pred.get("head_sha") == "161014fd8598977d05e0d8c1ac9723739e54dcca", "predecessor head drift")
    require(pred.get("integrated_to_main") is False, "predecessor integration claimed early")

    main = source.get("current_main", {})
    require(main.get("observed_sha") == "cb2bffe74e62804250ac36168c4206cb8b9d021a", "observed main drift")
    ...
    require(exc.get("base_branch") == "governance/ws615-final-workflow", "preparation exception base drift")
    require(exc.get("base_sha") == "161014fd8598977d05e0d8c1ac9723739e54dcca", "preparation exception base SHA drift")
    ...
    require(all(item.get("satisfied") is False for item in preconditions), "finalization precondition claimed early")
    ...
    require(completion.get("next_action") == "integrate_predecessor_chain_then_finalize_permanent_release", "next action drift")
...
def repository_failures(contract: dict[str, Any]) -> list[str]:
    ...
    for token in (
        ...
        "161014fd8598977d05e0d8c1ac9723739e54dcca",
    ...
    require(contract.get("satisfied_finalization_precondition_count") == 0, "contract claimed satisfied preconditions")
...
def main() -> None:
    ...
    print(
        ...
        "preconditions=0/6, release_absent=true, finalizer_self_test=passed, "
