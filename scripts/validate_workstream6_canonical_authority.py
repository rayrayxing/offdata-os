...
def failures(registry: dict[str, Any]) -> list[str]:
    ...
    require(isinstance(status, str) and "WS6.14" in status, "canonical integrated WS6.14 status missing")
    require(isinstance(status, str) and "WS6.15–WS6.16 final reconciliation" in status, "unintegrated successor boundary missing")
...
def main() -> None:
    ...
    print(
        ...
        "integrated_through=WS6.14, remaining_blockers=1, codex_start_authorized=false."
    )
