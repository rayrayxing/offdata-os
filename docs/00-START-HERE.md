...
6. `contracts/workstream6-required-workflow-identity.json`;
...
2. WS6.15 has activated `.github/workflows/workstream6-final-pre-codex.yml`, and issue #19 records hosted enforcement of exactly `Validate final pre-Codex canonical handoff and complete release` together with exact-allowlist branch cleanup;
